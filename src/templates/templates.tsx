...
export function MidnightQuote(props: CardProps) {
  ...
  return <div className="template midnight" style={{ backgroundColor: d.backgroundColor, color: d.textColor, fontFamily: fontFamilies[d.fontId] }}>
    ...
    <AutoFit as="blockquote" max={d.fontSize} min={40} style={{ letterSpacing: `${d.letterSpacing / 100}em`, fontWeight: d.fontId === 'kopub-batang-bold' ? 700 : 400 }}><span>{richText(text(props.page, 'body'))}</span></AutoFit>
